...
private:
	...
	/*
	 * Pre: ---
	 * Post: Libera la memoria de cada celular dentro de la lista, destruyendo esta tambien
	 *       durante la ejecucion.
	 */
	void destroyCellphones(List<Cellphone*>* cellphoneList);

	/*
	 * Pre: ---
	 * Post: Libera la memoria de cada llamada dentro de la lista, destruyendo esta tambien
	 *       durante la ejecucion.
	 */
	void destroyCalls(List<Call*>* callList);

	/*
	 * Pre: ---
	 * Post: Libera la memoria de cada antena dentro de la lista, destruyendo esta tambien
	 *       durante la ejecucion.
	 */
	void destroyAntennas(List<Antenna*>* antennaList);
